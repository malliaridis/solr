...
internal class SolrContextOptions(
    name: String = "Solr Context Options",
    help: String = "Context options that configure basic directories for a specific Solr context.",
