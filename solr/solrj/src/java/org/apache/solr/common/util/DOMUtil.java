...
public class DOMUtil {
  ...
  public static final Set<String> NL_TAGS =
   ...
   *
   * <p>This method is provided to support the same functionality as Node.getTextContent() but in a
   * way that is DOM Level 2 compatible.
   *
   * @see <a href="http://www.w3.org/TR/DOM-Level-3-Core/core.html#Node3-textContent">DOM Object
   *     Model Core</a>
   */
