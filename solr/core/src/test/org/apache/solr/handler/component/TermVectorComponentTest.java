  ...
  public void testCanned() throws Exception {
    ...
    assertU(
        adoc(
            ...
            "0",
            "test_posoffpaytv",
            "This is a title and another title",
            "test_posofftv",
            "This is a title and another title",
            "test_basictv",
            "This is a title and another title",
  ...
  private void doPerField() throws Exception {
    assertJQ(
        req(
            ...
            "test_basictv,test_notv,test_postv,test_offtv,test_posofftv,test_posoffpaytv",
            "f.test_posoffpaytv." + TermVectorParams.PAYLOADS,
            "false",
