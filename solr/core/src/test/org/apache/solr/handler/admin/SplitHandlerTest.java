...
// See SplitByPrefixTest for cloud level tests of SPLITSHARD that use this by passing getRanges with
// the SPLIT command
public class SplitHandlerTest extends SolrTestCaseJ4 {
  ...
  public void testSplitRecommendations() throws Exception {
    ...
    // The current implementation has specific code for the latter case (hence this is needed for
    // code coverage)
    ...
    // test that if largest count is last (this has specific code since we don't get over midpoint
