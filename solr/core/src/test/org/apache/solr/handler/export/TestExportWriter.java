...
public class TestExportWriter extends SolrTestCaseJ4 {
  ...
  public void testSmallChains() throws Exception {
    ...
    assertU(adoc("id", "1", "field1_i_p", Integer.toString(Integer.MIN_VALUE), "field2_i_p", "1"));
    assertU(commit());
    ...
    s =
        h.query(
            req(
                ...
                "id",
                "sort",
                "field1_i_p asc,field2_i_p asc,field3_i_p asc,field4_i_p asc,field5_i_p desc,field6_i_p desc,field7_i_p desc,field8_i_p asc"));
    assertJsonEquals(
        s,
        "{\n"
            + "  \"responseHeader\":{\"status\":0},\n"
  ...
  public void testBooleanField() throws Exception {
    ...
    assertU(adoc("id", "1", "booleandv", "true"));
    assertU(commit());
  ...
  private void testSortingOutput() throws Exception {
    ...
    assertJsonEquals(
        s,
        "{\"responseHeader\": {\"status\": 0}, \"response\":{\"numFound\":1, \"docs\":[{\"floatdv\":2.1,\"intdv\":1,\"stringdv\":\"hello world\",\"longdv\":323223232323,\"doubledv\":2344.345}]}}");
    ...
    assertJsonEquals(
        s,
        "{\"responseHeader\": {\"status\": 0}, \"response\":{\"numFound\":1, \"docs\":[{\"floatdv\":2.1,\"intdv\":7,\"longdv\":323223232323,\"doubledv\":2344.345}]}}");
    ...
    assertJsonEquals(
        s,
        "{\"responseHeader\": {\"status\": 0}, \"response\":{\"numFound\":1, \"docs\":[{\"intdv_m\":[100,250],\"floatdv_m\":[123.321,345.123],\"doubledv_m\":[3444.222,23232.2],\"longdv_m\":[343332,43434343434],\"stringdv_m\":[\"Everton\",\"liverpool\",\"manchester \\\"city\\\"\"]}]}}");
    ...
    s =
        h.query(
            req(
                ...
                "intdv",
                "sort",
                "floatdv asc,stringdv asc,intdv desc"));
    assertJsonEquals(
        s,
    ...
    s =
        h.query(
            req(
                ...
                "intdv",
                "sort",
                "floatdv asc,stringdv desc,intdv asc"));
    assertJsonEquals(
        s,
    ...
    s =
        h.query(
            req(
                ...
                "intdv",
                "sort",
                "floatdv asc,floatdv desc,floatdv asc,intdv desc"));
    assertJsonEquals(
        s,
        "{\"responseHeader\": {\"status\": 0}, \"response\":{\"numFound\":3, \"docs\":[{\"intdv\":3},{\"intdv\":2},{\"intdv\":1}]}}");
    ...
    s =
        h.query(
            req(
                ...
                "intdv",
                "sort",
                "intdv desc,floatdv asc,floatdv desc,floatdv asc,intdv desc"));
    assertJsonEquals(
        s,
        "{\"responseHeader\": {\"status\": 0}, \"response\":{\"numFound\":3, \"docs\":[{\"intdv\":3},{\"intdv\":2},{\"intdv\":1}]}}");
    s =
        h.query(
            req(
                ...
                "intdv",
                "sort",
                "floatdv desc,intdv asc,floatdv desc,floatdv desc,intdv desc"));
    assertJsonEquals(
        s,
        "{\"responseHeader\": {\"status\": 0}, \"response\":{\"numFound\":3, \"docs\":[{\"intdv\":1},{\"intdv\":2},{\"intdv\":3}]}}");
    ...
    s =
        h.query(
            req(
                ...
                "intdv",
                "sort",
                "floatdv asc,intdv desc,floatdv asc,floatdv desc,floatdv asc,intdv asc"));
    assertJsonEquals(
        s,
        "{\"responseHeader\": {\"status\": 0}, \"response\":{\"numFound\":3, \"docs\":[{\"intdv\":3},{\"intdv\":2},{\"intdv\":1}]}}");
    ...
    s =
        h.query(
            req(
                ...
                "intdv",
                "sort",
                "floatdv desc,intdv asc,floatdv desc,floatdv asc,floatdv desc,floatdv asc,intdv desc"));
    assertJsonEquals(
        s,
        "{\"responseHeader\": {\"status\": 0}, \"response\":{\"numFound\":3, \"docs\":[{\"intdv\":1},{\"intdv\":2},{\"intdv\":3}]}}");
    ...
    s =
        h.query(
            req(
                ...
                "intdv",
                "sort",
                "floatdv asc,intdv desc,floatdv asc,floatdv desc,floatdv asc,floatdv desc,floatdv asc,intdv asc"));
    assertJsonEquals(
        s,
        "{\"responseHeader\": {\"status\": 0}, \"response\":{\"numFound\":3, \"docs\":[{\"intdv\":3},{\"intdv\":2},{\"intdv\":1}]}}");
    s =
        h.query(
            req(
                ...
                "intdv",
                "sort",
                "intdv asc,floatdv desc,floatdv asc,floatdv desc,floatdv asc,floatdv desc,floatdv asc,intdv desc"));
    assertJsonEquals(
        s,
        "{\"responseHeader\": {\"status\": 0}, \"response\":{\"numFound\":3, \"docs\":[{\"intdv\":1},{\"intdv\":2},{\"intdv\":3}]}}");
    ...
    s =
        h.query(
            req(
                ...
                "intdv",
                "sort",
                "intdv asc,floatdv desc,floatdv asc,floatdv desc,floatdv asc,floatdv desc,intdv asc,intdv desc,floatdv asc"));
    assertJsonEquals(
        s,
        "{\"responseHeader\": {\"status\": 0}, \"response\":{\"numFound\":3, \"docs\":[{\"intdv\":1},{\"intdv\":2},{\"intdv\":3}]}}");
    s =
        h.query(
            req(
                ...
                "intdv",
                "sort",
                "floatdv asc,intdv desc,floatdv asc,floatdv desc,floatdv asc,floatdv desc,intdv desc,intdv asc,floatdv asc"));
    assertJsonEquals(
        s,
        "{\"responseHeader\": {\"status\": 0}, \"response\":{\"numFound\":3, \"docs\":[{\"intdv\":3},{\"intdv\":2},{\"intdv\":1}]}}");
    ...
    s =
        h.query(
            req(
                ...
                "intdv",
                "sort",
                "intdv asc,floatdv desc,floatdv asc,floatdv desc,floatdv asc,floatdv desc,intdv asc,intdv desc,floatdv desc,floatdv asc"));
    assertJsonEquals(
        s,
        "{\"responseHeader\": {\"status\": 0}, \"response\":{\"numFound\":3, \"docs\":[{\"intdv\":1},{\"intdv\":2},{\"intdv\":3}]}}");
    s =
        h.query(
            req(
                ...
                "intdv",
                "sort",
                "floatdv asc,intdv desc,floatdv asc,floatdv desc,floatdv asc,floatdv desc,intdv desc,intdv asc,floatdv desc,floatdv asc"));
    assertJsonEquals(
        s,
        "{\"responseHeader\": {\"status\": 0}, \"response\":{\"numFound\":3, \"docs\":[{\"intdv\":3},{\"intdv\":2},{\"intdv\":1}]}}");
  ...
  /**
   * This test doesn't validate the correctness of results, it just compares the response of the
   * same request when asking for Trie fields vs Point fields. Can be removed once Trie fields are
   * no longer supported
   */
  @Test
    ...
    for (int i = 0; i < numDocs; i++) {
      ...
      assertU(
          adoc(
              ...
              String.valueOf(i),
              "floatdv",
              String.valueOf(float_vals[number]),
              "intdv",
              String.valueOf(number),
              "stringdv",
              String.valueOf(str_vals[number]),
              "longdv",
              String.valueOf(number),
              "doubledv",
              String.valueOf(number),
  ...
  public void testExpr() throws Exception {
    ...
    req =
        req(
            ...
            "sortabledv_udvas asc",
            "expr",
            "unique(input(),over=\"sortabledv_udvas\")");
    String rsp = h.query(req);
    Map<String, Object> rspMap = mapper.readValue(rsp, HashMap.class);
    List<Map<String, Object>> docs =
        (List<Map<String, Object>>) Utils.getObjectByPath(rspMap, false, "/response/docs");
    ...
    req =
        req(
            ...
            "sortabledv_udvas asc",
            "expr",
            "rollup(input(),over=\"sortabledv_udvas\", sum(small_i_p),avg(small_i_p),min(small_i_p),count(*))");
    rsp = h.query(req);
    ...
    req =
        req(
            ...
            "sortabledv asc",
            "expr",
            "unique(input(),over=\"sortabledv\")");
    rsp = h.query(req);
    rspMap = mapper.readValue(rsp, HashMap.class);
    assertEquals(
        "wrong response status",
        400,
        ((Number) Utils.getObjectByPath(rspMap, false, "/responseHeader/status")).intValue());
    docs = (List<Map<String, Object>>) Utils.getObjectByPath(rspMap, false, "/response/docs");
  ...
  private void validateSort(int numDocs) throws Exception {
    ...
    for (int i = 0; i < fieldSorts.length; i++) {
      fieldSorts[i] =
          new SortFields(fieldNames.get(TestUtil.nextInt(random(), 0, fieldNames.size() - 1)));
  ...
  private void doTestQuery(String query, List<String> trieFields, List<String> pointFields)
      throws Exception {
    String trieFieldsFl = String.join(",", trieFields);
    String pointFieldsFl = String.join(",", pointFields);
    String sort =
        pickRandom(
                    (String) pickRandom(trieFields.toArray()),
                    (String) pickRandom(pointFields.toArray()))
                .replace("s_", "_")
            + pickRandom(" asc", " desc");
    String resultPoints =
