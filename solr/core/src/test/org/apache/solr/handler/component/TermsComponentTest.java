...
public class TermsComponentTest extends SolrTestCaseJ4 {
  ...
  public void testTermsList() {
    ...
    assertQ(
        req(
            ...
            "standardfilt",
            "terms.list",
            "spider,snake,a\\,b,shark,ddddd,bad"),
        "count(//lst[@name='standardfilt']/*)=5",
  ...
  public void testTermsWithJSON() throws Exception {
    ...
    assertJQ(
        ...
        "/terms/standardfilt/[3]==3",
        "/terms/standardfilt/[4]==spider",
        "/terms/standardfilt/[5]==1");
    ...
    assertJQ(
        ...
        "/terms/standardfilt/[2]==snake",
        "/terms/standardfilt/[3]/df==3",
        "/terms/standardfilt/[3]/ttf==3",
        "/terms/standardfilt/[4]==spider",
        "/terms/standardfilt/[5]/df==1",
        "/terms/standardfilt/[5]/ttf==1");
  }
  ...
  public void testPointField() throws Exception {
    ...
    try (SolrQueryRequest req =
       ...
       * ((AssertingLeafReader.AssertingPointValues) pv).getWrapped(); } System.out.println("pv=" +
       * pv); BKDReader bkdr = (BKDReader)pv;
       *
       * <p>for (int i=0; i<Math.min(10,nvals); i++) { System.out.println("INDEXED VAL=" + vals[i]);
       * }
       */
      ...
      PointMerger.ValueIterator iter =
          new PointMerger.ValueIterator(
              req.getSchema().getField("foo_pi"),
              req.getSearcher().getIndexReader().leaves(),
              totBuff,
              minSegBuff);
      ...
      iter =
          new PointMerger.ValueIterator(
              req.getSchema().getField("foo_pl"), req.getSearcher().getIndexReader().leaves());
      ...
      iter =
          new PointMerger.ValueIterator(
              req.getSchema().getField("foo_pf"), req.getSearcher().getIndexReader().leaves());
      ...
      iter =
          new PointMerger.ValueIterator(
              req.getSchema().getField("foo_pd"), req.getSearcher().getIndexReader().leaves());
