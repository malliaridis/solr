...
class FacetRangeProcessor extends FacetProcessor<FacetRange> {
   ...
   *
   * <ul>
   *   <li>If this is a phase#1 shard request, then {@link #createRangeList} will set this value
   *       (non null) if and only if it is needed for refinement (ie: <code>hardend:false</code>
   *       &amp; <code>other</code> that requires an end value low/high value calculation). And it
   *       wil be included in the response
   *   <li>If this is a phase#2 refinement request, this variable will be used {@link
   ...
   *       <code>other</code> buckets that need them
   * </ul>
   */
  @SuppressWarnings({"rawtypes"})
  ...
  /**
   * Returns a {@link Calc} instance to use for <em>term</em> faceting over a numeric field. This
   * method is unused for <code>range</code> faceting, and exists solely as a helper method for
   * other classes
   *
   * @param sf A field to facet on, must be of a type such that {@link FieldType#getNumberType} is
   *     non null
   * @return a <code>Calc</code> instance with {@link Calc#bitsToValue} and {@link
   ...
   * @see #fillBucket
   */
  private SimpleOrderedMap<Object> refineRange(
      Range range, boolean skip, Map<String, Object> facetInfo) throws IOException {
