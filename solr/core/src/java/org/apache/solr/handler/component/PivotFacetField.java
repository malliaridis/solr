 ...
 * child. This <code>PivotFacetField</code> may itself be a child of a {@link PivotFacetValue}
 * parent.
 *
 * @see PivotFacetValue
...
public class PivotFacetField {
   ...
   *
   * <p>This method should only be called after all refinement is completed just prior calling
   ...
   * represended in the <code>response</code>.
   *
  ...
  public void contributeFromShard(
      int shardNumber, ResponseBuilder rb, List<NamedList<Object>> response) {
