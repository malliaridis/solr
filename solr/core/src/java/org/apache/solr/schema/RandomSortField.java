 ...
 *
 * <p>This random sorting implementation uses the dynamic field name to set the random 'seed'. To
 * get random sorting order, you need to use a random dynamic field name. For example, you will need
 ...
 *
 * <ul>
 *   <li>http://localhost:8983/solr/select/?q=*:*&amp;fl=name&amp;sort=random_1234%20desc
 *   <li>http://localhost:8983/solr/select/?q=*:*&amp;fl=name&amp;sort=random_2345%20desc
 *   <li>http://localhost:8983/solr/select/?q=*:*&amp;fl=name&amp;sort=random_ABDC%20desc
 *   <li>http://localhost:8983/solr/select/?q=*:*&amp;fl=name&amp;sort=random_21%20desc
 * </ul>
 *
...
public class RandomSortField extends FieldType {
  ...
  /**
   * Given a field name and an IndexReader, get a random hash seed. Using dynamic fields, you can
   * force the random order to change
   */
  ...
  private static FieldComparatorSource randomComparatorSource =
  ...
  public static class RandomValueSource extends ValueSource {
    ...
    public FunctionValues getValues(
        Map<Object, Object> context, final LeafReaderContext readerContext) throws IOException {
