...
public final class IndexDeletionPolicyWrapper extends IndexDeletionPolicy {
   ...
   *
   * <p>This map is atomically replaced by {@link #updateKnownCommitPoints}. The keys are the {@link
   ...
   *
   * <p>This commit is implicitly protected from deletion in {@link IndexCommitWrapper#delete}
   *
   * @see #getLatestCommit
   ...
   *
   * <p>The keys of the {@link IndexCommit#getGeneration} of a commit, the values are a reference
   ...
   *
   * <p>If the return value is non-null, then the caller <em>MUST</em> call {@link
   ...
   *
   * <p>This Impl passes the list of commits to the delegate Policy <em>AFTER</em> wrapping each
   ...
   *
   * <p>This is handled special, and not included in {@link #updateKnownCommitPoints}, because we
   * need to ensure this happens <em>before</em> delegating calls to {@link #onInit} or {@link
