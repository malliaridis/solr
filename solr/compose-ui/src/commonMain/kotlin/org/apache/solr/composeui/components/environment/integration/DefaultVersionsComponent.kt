 ...
 */
class DefaultVersionsComponent(
    componentContext: AppComponentContext,
    storeFactory: StoreFactory,
    httpClient: HttpClient,
) : VersionsComponent, AppComponentContext by componentContext {
    ...
    override val model = store.stateFlow.map(mainScope, nodesStoreStateToVersionsModel)
}
