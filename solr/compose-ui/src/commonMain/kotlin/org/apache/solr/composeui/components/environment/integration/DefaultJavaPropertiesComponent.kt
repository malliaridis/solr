 ...
 */
class DefaultJavaPropertiesComponent(
    componentContext: AppComponentContext,
    storeFactory: StoreFactory,
    httpClient: HttpClient,
) : JavaPropertiesComponent, AppComponentContext by componentContext {
    ...
    override val model = store.stateFlow.map(mainScope, nodesStoreStateToJavaPropsModel)
}
