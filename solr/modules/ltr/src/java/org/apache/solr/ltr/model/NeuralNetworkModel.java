 ...
 *
 * <p>Supported <a href="https://en.wikipedia.org/wiki/Activation_function">activation functions</a>
 * are: <code>identity</code>, <code>relu</code>, <code>sigmoid</code>, <code>tanh</code>, <code>
 * leakyrelu</code> and contributions to support additional activation functions are welcome.
 *
 ...
 *
 * <ul>
 *   <li><a href="https://keras.io">Keras</a> is a high-level neural networks API, written in
 *       Python. A Keras and Solr implementation of RankNet can be found at <a
 *       href="https://github.com/airalcorn2/RankNet">https://github.com/airalcorn2/RankNet</a>.
 * </ul>
 *
 * <p>Background reading:
 *
 * <ul>
 *   <li><a href="http://icml.cc/2015/wp-content/uploads/2015/06/icml_ranking.pdf">C. Burges, T.
 *       Shaked, E. Renshaw, A. Lazier, M. Deeds, N. Hamilton, and G. Hullender. Learning to Rank
 *       Using Gradient Descent. Proceedings of the 22nd International Conference on Machine
 *       Learning (ICML), ACM, 2005.</a>
 * </ul>
 */
public class NeuralNetworkModel extends LTRScoringModel {

  /**
   * layers is part of the LTRScoringModel params map and therefore here it does not individually
