...
class ServletRequestJavaxDelegate implements ServletRequest {

  protected final jakarta.servlet.ServletRequest delegate;

  public ServletRequestJavaxDelegate(jakarta.servlet.ServletRequest request) {
