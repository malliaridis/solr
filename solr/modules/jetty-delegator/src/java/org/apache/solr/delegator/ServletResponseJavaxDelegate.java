...
class ServletResponseJavaxDelegate implements ServletResponse {

  final jakarta.servlet.ServletResponse delegate;

  public ServletResponseJavaxDelegate(jakarta.servlet.ServletResponse response) {
    delegate = response;
  }
