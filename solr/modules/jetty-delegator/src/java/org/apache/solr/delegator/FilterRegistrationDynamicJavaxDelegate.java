...
public class FilterRegistrationDynamicJavaxDelegate implements FilterRegistration.Dynamic {

  final jakarta.servlet.FilterRegistration.Dynamic delegate;

  public FilterRegistrationDynamicJavaxDelegate(
      final jakarta.servlet.FilterRegistration.Dynamic registration) {
  ...
  public void addMappingForServletNames(
    ...
    EnumSet<jakarta.servlet.DispatcherType> mappedDispatcherTypes =
        dispatcherTypes.stream()
            .map(Delegates::dispatcherType)
            .collect(
                Collectors.toCollection(
                    () -> EnumSet.noneOf(jakarta.servlet.DispatcherType.class)));
