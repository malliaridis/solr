...
public class JspPropertyGroupDescriptorJavaxDelegate implements JspPropertyGroupDescriptor {

  final jakarta.servlet.descriptor.JspPropertyGroupDescriptor delegate;

  JspPropertyGroupDescriptorJavaxDelegate(
