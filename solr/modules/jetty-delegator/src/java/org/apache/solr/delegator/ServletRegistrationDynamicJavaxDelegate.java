...
public class ServletRegistrationDynamicJavaxDelegate implements ServletRegistration.Dynamic {

  private static final Logger log = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass());

  final jakarta.servlet.ServletRegistration.Dynamic delegate;

  ServletRegistrationDynamicJavaxDelegate(
      final jakarta.servlet.ServletRegistration.Dynamic registration) {
  ...
  public Set<String> setServletSecurity(ServletSecurityElement constraint) {
    return delegate.setServletSecurity(servletSecurityElement(constraint));
  }

  @Override
  public void setMultipartConfig(MultipartConfigElement multipartConfig) {
    delegate.setMultipartConfig(multipartConfigElement(multipartConfig));
  }
