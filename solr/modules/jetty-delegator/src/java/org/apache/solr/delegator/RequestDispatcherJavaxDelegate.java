...
public class RequestDispatcherJavaxDelegate implements RequestDispatcher {

  final jakarta.servlet.RequestDispatcher delegate;

  RequestDispatcherJavaxDelegate(final jakarta.servlet.RequestDispatcher dispatcher) {
    delegate = dispatcher;
  }
